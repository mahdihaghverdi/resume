...
\end{zitemize}
% ===================
\subsection{{AioClock --- \href{https://github.com/ManiMozaffar/aioclock}{link} \hfill \textit{A modern python scheduling framework with dependency injection.}}}
\begin{zitemize}
\item Add suport for timeouts in tasks --- \href{https://github.com/ManiMozaffar/aioclock/pull/26}{Pull Request \#26}
\end{zitemize}
% ===================
